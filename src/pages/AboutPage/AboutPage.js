      ...
      <div className='content-grid'>
        ...
        <div className='about-wrapper'>
          <div className='about-content' style={{ color: textPrimary }}>
            <p>
              I like <span className='highlight'>JavaScript</span> ,
              <span className='highlight'> Python</span> ,
              <span className='highlight'> Php</span> and everything web.
            </p>
            <p>
            ...
            <p>
              React-Redux, Node.js, Angular, SQL, Mongodb, Python, Docker, PHP,
              Laravel, Firebase and AWS are the main tricks up my sleeve. I am
              also obsessed with making the web look pretty with SASS/CSS.
            </p>
